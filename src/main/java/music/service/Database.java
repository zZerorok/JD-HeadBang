...
public class Database {
    ...
    public Database() {
        ...
        TrackDTO track1 = new TrackDTO("(여자)아이들", "퀸카",
                ...
                "K-Pop", "2023-05-15T12:00:00Z", "1684674424");
        ...
        TrackDTO track4 = new TrackDTO("뉴진스", "ETA",
                ...
                "K-Pop", "2023-07-21T12:00:00Z", "1695951888");
        ...
        albumList.add(
                new AlbumDTO("(여자)아이들", "2", 7.99, "(여자)아이들", "1725271942", Arrays.asList(track1, track2, track3)));
    }
